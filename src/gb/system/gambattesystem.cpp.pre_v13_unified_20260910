                                ...
                                Uint32 nFrames)
{
    ...
    while (pos < nFrames)
    {
        ...
        for (i = 0; i < batch; ++i)
        {
            ...
            /* AURORA_GB_FINAL_R1_MONO_OUTPUT_20260909
             * Collapse only at the host mixer boundary. Gambatte's APU,
             * routing registers, decimator and savestates remain stereo. */
            left[i] = mono;
            right[i] = mono;
        }
