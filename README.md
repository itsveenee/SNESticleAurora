...
Super Game Boy emulation will use **Gambatte** as the embedded Game Boy CPU/PPU/APU/MBC backend while Aurora emulates the SNES and ICD2 side. The integration is **experimental and currently does not work.** See [THIRD_PARTY.md](THIRD_PARTY.md) and `LICENSES/Gambatte-GPL-2.0.txt`.
